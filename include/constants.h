...
inline const std::string CSV_FILE = "combined_statements.csv";
...
namespace regex {
    ...
    inline const std::string TRANSACTION_TITLE = "Purchases, Balance Transfers & Other Charges"; /**< This text comes before transactions are listed */
    ...
    const std::regex transactionTitlePattern(TRANSACTION_TITLE);
